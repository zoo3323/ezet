...
├──────────────────────────────────────────────────────┤
│› dev           dev@192.0.2.10                        │
│ gpu-box       ml@192.0.2.42                          │
│ web-1         deploy@203.0.113.8                     │
╰──────────────────────────────────────────────────────╯

  ↑/↓ 이동 · Enter 선택 · / 검색 · n 추가 · e 수정 · d 삭제 · q 취소
```
...
│ VIA   SSH                                                            │
├──────────────────────────────────────────────────────────────────────┤
│ TMUX (2)             WIN   STATUS    IDLE    CMD           DIR       │
│› editor               3w    detached  1m      nvim          app      │
│ server               1w    detached  1h      node          api       │
├──────────────────────────────────────────────────────────────────────┤
│ SSH shell (no tmux)                                                  │
╰──────────────────────────────────────────────────────────────────────╯

  ↑/↓ · Enter 선택 · s SSH · p 미리보기 · n 새 세션 · r 이름 · / 검색 · q 종료
```
